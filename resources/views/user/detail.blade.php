                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <th>
                                        <div class="d-flex">
                                            <div>
                                                <img src="{{asset('assets/image/kit10.jpg')}}" style="width:70px;" class="rounded-3">
                                            </div>
                                    ...
                                    <th>
                                        <div class="d-flex">
                                            <div>
                                                <img src="{{asset('assets/image/kit11.jpg')}}" style="width:70px;" class="rounded-3">
                                            </div>
                                            <div class="p-3"><h5>Grinder</h5></div>
                                        </div>
                                    </th>
                                    <td>₹ 599.00</td>
                                    <td>02</td>
                                    ...
                                    <th>
                                        <div class="d-flex">
                                            <div>
                                                <img src="{{asset('assets/image/kit12.jpg')}}" style="width:70px;" class="rounded-3">
                                            </div>
                                            <div class="p-3"><h5>Salt</h5></div>
                                        </div>
                                    </th>
                                    <td>₹ 799.00</td>
                                    <td>03</td>
