                            ...
                            <div class="col-xl-8 col-md-8">
                                    <h4>Account Setting</h4>
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Anil">
                                        </div>

                                        <div class="col-lg-6 mb-3">
                                            <label class="form-label">Last Name</label>
                                            <input type="text" class="form-control" placeholder="Pokhrel">
                                        </div>

                                        <div class="col-lg-12 mb-3">
                                            <label class="form-label">Email</label>
                                            <input type="email" class="form-control" placeholder="anilpokhrel019@email.com">
                                        </div>
                            ...
                            <div class="col-xl-12 col-md-12">
                                    <h4>Billing Address</h4>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                <label class="form-label">Email</label>
                                                <input type="email" class="form-control" placeholder="anilpokhrel029@gmai.com">
                                            </div>
